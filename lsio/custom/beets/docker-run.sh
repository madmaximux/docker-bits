...
docker run -d \
  ...
  -v ${DOCKERCONFIGPATH:-/volume1/docker/appdata}/beets/music:/music `# Music library` \
  -v ${DOCKERCONFIGPATH:-/volume1/docker/appdata}/beets/downloads:/downloads `# Non processed music` \
