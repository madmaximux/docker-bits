...
docker run -d \
  ...
  -v ${DOCKERCONFIGDIR:-/volume1/docker/appdata}/mstream/config:/config `# mStream config` \
  -v ${DOCKERCONFIGDIR:-/volume1/docker/appdata}/mstream/music:/music `# Music location` \
